...
public class Selection implements ActionListener {
	 ...
	 * 
	 * @param GameType
	 *            a string for the current game type
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		// /This if statement implements a action listener for the first
		// JTextField for player one
		...
		// /This if statement implements a action listener for the second
		// JTextField for player two
		if (e.getSource() == playerTwo) {
			// ////setting the Player two name to what is typed into the text
			// field
			setPlayerNameTwo(playerTwo.getText());
		}

		// /this if statement implements a action listener for the JButton
		// btn_cancel
